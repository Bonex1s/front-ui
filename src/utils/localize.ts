const localize = {
  ...
  /// product
  ProductCreateTitle: 'Базова інформація',
  ...
  // CARDS
  temporaryCards: [
    { id: 1, rating: 4, title: 'Чохол Benks Lucid Armor Case for iPhone 17 Pro Max with MagSafe Black', price: '1999грн', imageUrl: 'https://thegadget.ua/images/products/2dc9f7afa14feb51b65c40c916d2a471754798512d6207490d6bdf83300c7d74.webp',   },
  ...
  caseSubMenu: [
    { title: 'iPhone',
      items: [
        ...
        { id: 4, label: 'iPhone 14' },
        { id: 5, label: 'iPhone 14 Pro' },
        { id: 6, label: 'iPhone 14 Pro Max' },
      ], }, 
    { title: 'Samsung',
      items: [
        { id: 1, label: 'Samsung S22' },
        { id: 2, label: 'Samsung S23' },
        { id: 3, label: 'Samsung Z Flip' },
      ], },
    { title: 'Xiaomi',
      items: [
        { id: 1, label: 'Xiaomi 12' },
        { id: 2, label: 'Xiaomi 13' },
